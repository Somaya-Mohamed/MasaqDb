...
{
    /// <inheritdoc />
    public partial class ALLAddAccountRolesUserProfilesAndRelationships : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HumanBaseEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HumanBaseEntity_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HumanBaseEntity_Accounts_Teacher_AccountId",
                        column: x => x.Teacher_AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HumanBaseEntity_Levels_levelFK",
                        column: x => x.levelFK,
                        principalTable: "Levels",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserNotifications", x => new { x.HumanBaseEntityId, x.NotificationId });
                    table.ForeignKey(
                        name: "FK_UserNotifications_HumanBaseEntity_HumanBaseEntityId",
                        column: x => x.HumanBaseEntityId,
                        principalTable: "HumanBaseEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcements_HumanBaseEntity_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_HumanBaseEntity_StudentIdFK",
                        column: x => x.StudentIdFK,
                        principalTable: "HumanBaseEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_Lessons_LessonIdFK",
                        column: x => x.LessonIdFK,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentLessons_HumanBaseEntity_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentExams_HumanBaseEntity_StudentId",
                        column: x => x.StudentId,
                        principalTable: "HumanBaseEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAnswers", x => new { x.StudentExamId, x.QuestionId });
                    table.ForeignKey(
                        name: "FK_StudentAnswers_QuestionOptions_AnswerId",
                        column: x => x.AnswerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_LessonIdFK",
                table: "Comments",
                column: "LessonIdFK");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_StudentIdFK",
                table: "Comments",
                column: "StudentIdFK");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HumanBaseEntity_AccountId",
                table: "HumanBaseEntity",
                column: "AccountId",
                unique: true,
                filter: "[AccountId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_HumanBaseEntity_levelFK",
                table: "HumanBaseEntity",
                column: "levelFK");

            migrationBuilder.CreateIndex(
                name: "IX_HumanBaseEntity_Teacher_AccountId",
                table: "HumanBaseEntity",
                column: "Teacher_AccountId");
